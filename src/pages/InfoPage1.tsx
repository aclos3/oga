...
const InfoPage1: React.FC<ContainerProps> = ({ match, history }) => { 
    return (
    <IonPage>
      <IonHeader>
        <IonToolbar>
        ...
        <IonContent scrollEvents={true}>
          ...
          <IonList>
            <IonItem><a href="/dashboard/info1#frost-data"> Frost Data </a></IonItem>
            <IonItem><a href="/dashboard/info1#location-data"> Location Data </a></IonItem>
            <IonItem><a href="/dashboard/info1#the-team"> The Team </a></IonItem>
            <IonItem><a href="/dashboard/info1#our-partners"> Our Partners </a></IonItem>
            <div id="frost-data">
              <h3>Frost Data</h3>
