...
describe('getClosestPoint', () => {
    const eugene: Position = {lat: 44.032883, long: -123.090570};               // closest: Springfield
    const medford: Position = {lat: 42.282803, long: -122.771226};              // closest: Grants Pass
    const steensMountain: Position = {lat: 42.6202388, long: -118.6244009};     // closest: Malheur Lake
    const burns: Position = {lat: 43.5835747, long: -119.0585662};              // closest: Malheur Lake
    const malheurLake: Position = {lat: 43.3302915, long: -118.8115772};        // closest: Burns
    const joseph: Position = {lat: 45.3506504, long: -117.2287770};             // closest: La Grande
    const laGrande: Position = {lat: 45.3276834, long: -118.0967850};           // closest: Joseph       
    const tillamook: Position = {lat: 45.4564555, long: -123.8370981};          // closest: Oceanside
    const oceanside: Position = {lat: 45.4577467, long: -123.9673364};          // closest: Tillamook
    const springfield: Position = {lat: 44.0523465, long: -122.9966305};        // closest: Eugene
    const grantsPass: Position = {lat: 42.4382946, long: -123.3212346};         // closest: Medford
